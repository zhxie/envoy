...
REPOSITORY_LOCATIONS_SPEC = dict(
    ...
    com_github_intel_dml = dict(
        ...
        version = "1.1.0",
        sha256 = "0264425b4b35facc5916045da47a08ff5405e0401ab5701505a1deec57fd334c",
        strip_prefix = "DML-{version}",
        urls = ["https://github.com/intel/DML/archive/refs/tags/v{version}.tar.gz"],
        release_date = "2023-07-19",
        use_category = ["dataplane_ext"],
        extensions = ["envoy.transport_sockets.tap"],
        cpe = "N/A",
        license = "MIT",
        license_url = "https://github.com/intel/DML/blob/v{version}/LICENSE",
    ),
