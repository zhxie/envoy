...
REPOSITORY_LOCATIONS_SPEC = dict(
    ...
    com_github_intel_idxd_config = dict(
        project_name = "accel-config",
        project_desc = "Accel-config / libaccel-config",
        project_url = "https://github.com/intel/idxd-config",
        version = "3.4.6.4",
        sha256 = "5f9ee68f51913d803b9b0e51cdadaff14ea1523f6e9e4d4ab3e85de644ba6d21",
        strip_prefix = "idxd-config-accel-config-v{version}",
        urls = ["https://github.com/intel/idxd-config/archive/accel-config-v{version}.tar.gz"],
        release_date = "2022-04-29",
        use_category = ["other"],
        extensions = ["envoy.bootstrap.idxd"],
        cpe = "N/A",
    ),
