...
REPOSITORY_LOCATIONS_SPEC = dict(
    ...
    org_llhttp = dict(
        project_name = "llhttp",
        project_desc = "Port of http_parser to llparse",
        project_url = "https://llhttp.org/",
        version = "8.1.1",
        sha256 = "ec9b6d829ed4c4594f1f1b8fe4c832fdace864dd99fa5db5118dfc49b08d9b14",
        strip_prefix = "llhttp-release-v{version}",
        urls = ["https://github.com/nodejs/llhttp/archive/refs/tags/release/v{version}.tar.gz"],
        use_category = ["controlplane", "dataplane_core"],
        release_date = "2023-06-21",
        cpe = "cpe:2.3:a:llhttp:llhttp:*",
        license = "MIT",
        license_url = "https://github.com/nodejs/llhttp/blob/v{version}/LICENSE-MIT",
    ),
